...
git clone https://github.com/NENO8/GENERAAL.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf GENERAAL && rm -rf .telegram-cli && git clone https://github.com/NENO8/GENERAAL.git && cd GENERAAL && ./launch.sh install && ./launch.sh
~~~~~
